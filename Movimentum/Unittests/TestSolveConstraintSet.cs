...
namespace Movimentum.Unittests {
    ...
    class TestSolveConstraintSet {
        ...
        public void Test2SimpleConstraintsAndOneStep() {
            ...
            ConstraintSet set = ConstraintSet.Create(constraints, 0, 0);
            IEnumerable<ConstraintSet> setsAfterOneStep = set.Expand(new Dictionary<Variable, VariableRangeRestriction>());
        ...
        public void Test2SimpleConstraintsAndManySteps() {
            ...
            ConstraintSet result = RunSolverLoop(constraints);
        ...
        private static ConstraintSet RunSolverLoop(IEnumerable<ScalarEqualityConstraint> constraints) {
            ConstraintSet set = ConstraintSet.Create(constraints, 0, 0);
            int stepCt = 0;
            while (set.Constraints.Any()) {
                IEnumerable<ConstraintSet> expandedSets = set.Expand(new Dictionary<Variable, VariableRangeRestriction>());
        ...
        public void Solve2DependentConstraints() {
            ...
            IDictionary<Variable, VariableRangeRestriction> result = ConstraintSet.Solve(constraints, 0, 0, 10, new Dictionary<Variable, VariableRangeRestriction>(), -1);
        ...
        public void Solve2DependentConstraintsWithContradiction() {
            ...
            Assert.Throws<Exception>(() => ConstraintSet.Solve(constraints, 1, 1, 10, new Dictionary<Variable, VariableRangeRestriction>(), -1));
        }
        ...
        public void Solve2DependentConstraintsWithFormalSquareroots() {
            ...
            IDictionary<Variable, VariableRangeRestriction> result = ConstraintSet.Solve(constraints, 2, 2, 20, new Dictionary<Variable, VariableRangeRestriction>(), -1);
        ...
        public void Solve4DependentConstraintsWithFormalSquareroots() {
            ...
            IDictionary<Variable, VariableRangeRestriction> result = ConstraintSet.Solve(constraints, 3, 3, 20, new Dictionary<Variable, VariableRangeRestriction>(), -1);
