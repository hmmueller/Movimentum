...
namespace Movimentum.Unittests {
    ...
    class TestConstantFoldingVisitor {
        ...
        public void TestDontFoldConstant() {
            AbstractExpr input = (Polynomial.CreateConstant(1).C + Polynomial.CreateNamedVariable("b")) * Polynomial.CreateConstant(4);
            IAbstractExpr result = input.Accept(visitor, Ig.nore);
        ...
        public void TestDoFoldConstantLeftAndRightOfBinaryOp() {
            AbstractExpr input = (Polynomial.CreateConstant(1).C + Polynomial.CreateConstant(2)) / (Polynomial.CreateConstant(3).C + Polynomial.CreateConstant(4));
            IAbstractExpr result = input.Accept(visitor, Ig.nore);
        ...
        public void TestDoFoldConstantOnlyOnLeftSideOfBinaryOp() {
            AbstractExpr input = (Polynomial.CreateConstant(1).C + Polynomial.CreateConstant(2)) * Polynomial.CreateNamedVariable("c");
            IAbstractExpr result = input.Accept(visitor, Ig.nore);
            Assert.AreEqual(Polynomial.CreateConstant(3).C * Polynomial.CreateNamedVariable("c"), result);
        }

        [Test]
        public void TestDoFoldConstantOnlyOnRightSideOfBinaryOp() {
            AbstractExpr input = Polynomial.CreateNamedVariable("a").C * (Polynomial.CreateConstant(2).C + Polynomial.CreateConstant(3));
            IAbstractExpr result = input.Accept(visitor, Ig.nore);
            Assert.AreEqual(Polynomial.CreateNamedVariable("a").C * Polynomial.CreateConstant(5), result);
        }

        [Test]
        public void TestDontFoldConstantInBinaryOp() {
            AbstractExpr input = Polynomial.CreateNamedVariable("a").C * (Polynomial.CreateConstant(2).C + Polynomial.CreateNamedVariable("c"));
            IAbstractExpr result = input.Accept(visitor, Ig.nore);
            Assert.AreEqual(input, result);
            Assert.AreSame(input, result);
        }
        ...
        public void TestDoFoldConstantInUnaryMinus() {
            AbstractExpr input = -Polynomial.CreateConstant(4).C;
            IAbstractExpr result = input.Accept(visitor, Ig.nore);
            Assert.AreNotEqual(input, result);
        ...
        public void TestFoldingsInSimpleSums() {
            AbstractExpr input1 = Polynomial.CreateNamedVariable("a").C + Polynomial.CreateConstant(1).C + Polynomial.CreateConstant(2);
            AbstractExpr input2 = Polynomial.CreateConstant(1).C + Polynomial.CreateNamedVariable("a") + Polynomial.CreateConstant(2);
            AbstractExpr input3 = Polynomial.CreateConstant(1).C + Polynomial.CreateConstant(2).C + Polynomial.CreateNamedVariable("a");
            AbstractExpr input4 = Polynomial.CreateNamedVariable("a").C + (Polynomial.CreateConstant(1).C + Polynomial.CreateConstant(2));
            ...
            Assert.AreEqual(Polynomial.CreateConstant(3).C + Polynomial.CreateNamedVariable("a"), result3);
            Assert.AreEqual(Polynomial.CreateNamedVariable("a").C + Polynomial.CreateConstant(3), result4);
        }
